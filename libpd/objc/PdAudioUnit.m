...
static OSStatus AudioRenderCallback(void *inRefCon,
  ...
  //DEI edit for audiobus
  AudioTimeStamp timestamp = *inTimeStamp;
  if ( ABReceiverPortIsConnected(pdAudioUnit->_inputPort) ) {
    ...
    ABReceiverPortReceive(pdAudioUnit->_inputPort, nil, ioData, inNumberFrames, &timestamp);
  } else {
